   ...
   <li class="breadcrumb-item"><a href="messages.php?user=<?php echo $_SESSION['username'];?>" class="text-muted">Compose Message</a></li>
           ...
           <div class="container-fluid">
             ...
             <?php 
                         $e=$_GET['msid'];
                         $a=$_GET['msgSubject'];
						 $details=mysqli_fetch_array(mysqli_query($con,"SELECT msender FROM msgs WHERE msgSubject='$a' AND msid='$e'"));
						 ?> 
                                    <div class="form-body">
        ...
        <input required type="text" readonly name="recepient" class="form-control" value="<?php echo $details['msender'];?>">
